...
void MyFaceDetect::FaceDetectInit()
{
    // 将 xml 文件放在 exe 同级的目录下面
     ...
     QString eyes_cascade_name = QCoreApplication::applicationDirPath()+"/haarcascade_eye.xml";
...
void MyFaceDetect::detectAndDisplay(Mat &frame, std::vector<Rect> &faces)
{
    ...
    face_cascade.detectMultiScale( frame_gray, faces,1.1, 6, 0, Size(60,60) , Size(300, 300) );
