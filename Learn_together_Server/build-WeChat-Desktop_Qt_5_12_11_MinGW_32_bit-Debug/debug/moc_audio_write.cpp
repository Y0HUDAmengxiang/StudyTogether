...
#include "../../WeChat/AudioApi/audio_write.h"
...
QT_MOC_LITERAL(1, 12, 11), // "slot_net_rx"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 2) // "ba"

    },
    "Audio_Write\0slot_net_rx\0\0ba"
};
...
void Audio_Write::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Audio_Write *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_net_rx((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject Audio_Write::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Audio_Write.data,
    qt_meta_data_Audio_Write,
    qt_static_metacall,
    nullptr,
    nullptr
} };
