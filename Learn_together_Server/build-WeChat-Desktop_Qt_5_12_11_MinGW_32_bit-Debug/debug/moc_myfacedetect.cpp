...
#include "../../WeChat/VideoApi/myfacedetect.h"
...
QT_MOC_LITERAL(1, 13, 14), // "FaceDetectInit"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 16), // "detectAndDisplay"
QT_MOC_LITERAL(4, 46, 4), // "Mat&"
QT_MOC_LITERAL(5, 51, 5), // "frame"
QT_MOC_LITERAL(6, 57, 18), // "std::vector<Rect>&"
QT_MOC_LITERAL(7, 76, 5) // "faces"

    },
    "MyFaceDetect\0FaceDetectInit\0\0"
    "detectAndDisplay\0Mat&\0frame\0"
    "std::vector<Rect>&\0faces"
};
...
void MyFaceDetect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyFaceDetect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->FaceDetectInit(); break;
        case 1: _t->detectAndDisplay((*reinterpret_cast< Mat(*)>(_a[1])),(*reinterpret_cast< std::vector<Rect>(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject MyFaceDetect::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_MyFaceDetect.data,
    qt_meta_data_MyFaceDetect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
